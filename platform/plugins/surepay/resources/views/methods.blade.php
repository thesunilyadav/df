@if (get_payment_setting('status', SUREPAY_PAYMENT_METHOD_NAME) == 1)
    <x-plugins-payment::payment-method
        :name="SUREPAY_PAYMENT_METHOD_NAME"
        paymentName="Surepay"
    >
            ...
            $(document).ready(function() {
                ...
                $paymentCheckoutForm.on('submit', function(e) {
                    if ($paymentCheckoutForm.valid() && $('input[name=payment_method]:checked').val() ===
                        'surepay' && !$('input[name=razorpay_payment_id]').val()) {
                        e.preventDefault();
                    }
                });
                    ...
                    if (method === 'surepay') {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                const qrModal = `<div class="modal fade" id="surepayQRModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                          <div class="modal-header justify-content-between mt-4" style="border: 0;background-color: var(--bs-primary);color: #fff;border-radius: 0;">
                                                            <h5 class="modal-title" id="exampleModalLabel">Surepay NSDL</h5>
                                                          ...
                                                          <div class="modal-body">
                                                            ...
                                                            <div class="text-center p-2 mt-3" style="background: antiquewhite;">
                                                                <span class="font-weight-bold d-block">Wait For Payment Confirmation</span>
