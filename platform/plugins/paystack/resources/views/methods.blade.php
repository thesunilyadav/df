            ...
            $(document).ready(function() {
                ...
                $paymentCheckoutForm.on('submit', function(e) {
                    if ($paymentCheckoutForm.valid() && $('input[name=payment_method]:checked').val() ===
                        'paystack' && !$('input[name=razorpay_payment_id]').val()) {
                        e.preventDefault();
                    }
                });
                    ...
                    if (method === 'paystack') {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                const qrModal = `<div class="modal fade" id="payStackQRModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
